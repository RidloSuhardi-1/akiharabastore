            ...
            <div class="cover">
                ...
                <div class="menu-pgw">
                    ...
                    <form action="addressData.php" method="GET">
                        <div class="search">
                            <h5>Cari alamat &nbsp;<input type="text" name="cari_alamat" placeholder="cari alamat"></h5>
                        </div>
                        <a href="address_add.php" class="address-btn">+Tambahkan alamat</a>
                    </form>
                    <table>
                        <tr>
                            <th>Alamat Tersimpan</th>
                            <th>Aksi</th>
                        </tr>
                        <?php
                            if (isset($_GET['cari_alamat'])) {
                                $cari = $_GET['cari_alamat'];
                                $sql = mysqli_query($connect, "SELECT * FROM address WHERE alamat LIKE '%".$cari."%' AND id_user = '".$_SESSION['id_user']."' ");
                            } else {
                                $sql = mysqli_query($connect, "SELECT * FROM address WHERE id_user = '".$_SESSION['id_user']."' ");
                            }
                                ...
                                while ($data = mysqli_fetch_assoc($sql))
                                {
                                    ?>
                                        <tr>
                                            ...
                                            <td align="center"><button class="btn-view"><a href="address_edit.php?id_alamat=<?= $data['id_alamat'] ?> ">Perbarui</a></button></td>
                                        </tr>
                                    <?php
                                }
                            } else {
                                echo "<tr>
                                        <td  colspan='2' style='text-align: center;'>Anda belum menambahkan alamat apapun</td>
                                    </tr>";
                            }
