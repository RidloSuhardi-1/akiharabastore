        ...
        <div class="layout">
            ...
            <div class="cover">
                ...
                <div class="menu-pgw">
                    ...
                    <form action="../../../sistem/core/addAddress.php?id_user=<?= $_SESSION['id_user'] ?> " method="POST">
                        <h5>Tambah Alamat baru</h5>
                        <table>
                            <tr>
                                <td><p>Alamat baru</p></td>
                                <td><p><input type="text" name="alamat" placeholder="Alamat anda.." required></p></td>
                            </tr>
                        </table>
                        
                    
                </div><hr><br>
                        <button class="save-btn">Simpan alamat</button>
                    </form>
                    <button class="save-btn" style="background: #E53935;"><a href="addressData.php">Kembali</a></button>
