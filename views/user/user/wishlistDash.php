            ...
            <div class="cover">
                ...
                <div class="menu-pgw">
                    ...
                    <table>
                        ...
                        <?php
                            $sql = mysqli_query($connect, "SELECT * FROM wishlist WHERE id_user = '".$_SESSION['id_user']."' ");
                            ...
                            if (mysqli_num_rows($sql) > 0) {
                                while ($data = mysqli_fetch_assoc($sql))
                                {
                                    ...
                                    while ($dt = mysqli_fetch_assoc($query)) 
                                    {
                                        ?>
                                            ...
                                            <tr>
                                                <td align="center"><?= $dt['id_produk'] ?></td>
                                                <td align="center"><a href="../../page/productDetail.php?id_produk=<?= $dt['id_produk'] ?>" style="color: black;" title="Ketuk untuk melihat produk"><?= $dt['produk'] ?></a></td>
                                                <td align="center"><button class="btn-view"><a href="../../../sistem/core/deleteWishlist.php?id_wish=<?= $data['id_wish'] ?> ">Hapus</a></button></td>
                                            </tr>
                                        <?php
                                    }
                                }
                                ...
                                echo "<tr>
                                        <td  colspan='3' style='text-align: center;'>Anda belum memiliki produk favorit</td>
                                    </tr>";
                            }
