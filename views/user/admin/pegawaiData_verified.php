...
<html>
    ...
    <body>
        ...
        <div class="cover">
            <h2>Data Pegawai - Terverifikasi</h2>
            <hr>
            <div class="menu-pgw">
                <ul>
            ...
            <table>
                ...
                <?php
                    if (isset($_GET['cari_pegawai'])) {
                        ...
                        $sql = mysqli_query($connect, "SELECT * FROM karyawan WHERE status = 'verified' AND NOT id_pgw='".$_SESSION['id_pgw']."'  ");
                    }
                    ...
                    if (mysqli_num_rows($sql) > 0) {
                        ...
                        echo "<tr>
                                <td colspan='7' style='text-align: center;'>0 Data terverifikasi</td>
                            </tr>";
                    }
